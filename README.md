...
> ระบบบริหารการปฏิบัติงานออนไลน์ สำหรับหน่วยงานราชการ, โรงเรียน, สถานศึกษา, บริษัท และองค์กรทั่วไป  
> รองรับการปฏิบัติงานที่บ้าน (WFH), เข้าสำนักงาน, ออกปฏิบัติราชการ และออกปฏิบัติงานพื้นที่  
> มีระบบวางแผนการปฏิบัติงานรายสัปดาห์ พร้อม Admin Dashboard ครบครัน
...
| ฟีเจอร์                           | รายละเอียด                                                                              |
| --------------------------------- | --------------------------------------------------------------------------------------- |
| **ลงชื่อเข้างาน (Check-in)**      | บันทึกเวลาเข้างาน เลือกประเภท WFH / เข้าสำนักงาน / ไปราชการ / ออกปฏิบัติงานพื้นที่    |
| **ลงชื่อออกงาน (Check-out)**      | บันทึกเวลาออกงาน พร้อมสรุปชั่วโมงทำงาน                                                 |
| **อัปโหลดรูปภาพ**                 | แนบรูปภาพหลักฐานการปฏิบัติงานสูงสุด 3 รูป (JPG / PNG ขนาดสูงสุด 5MB ต่อรูป)            |
| **บันทึก GPS**                    | บันทึกพิกัดตำแหน่งอัตโนมัติพร้อม Check-in / Check-out                                  |
| **บันทึกภารกิจ**                  | อธิบายงานที่ปฏิบัติในวันนั้นๆ                                                           |
| **ประวัติการลงชื่อ**              | ดูประวัติย้อนหลัง กรองตามประเภทและช่วงวันที่ พร้อมรูปภาพที่แนบ                         |
...
| **วางแผนงานรายสัปดาห์**           | วางแผนประเภทการปฏิบัติงานล่วงหน้าทุกวัน (WFH / สำนักงาน / ราชการ / พื้นที่ / ลา)      |
| **บันทึกผลการปฏิบัติงาน**         | บันทึกโน้ตสรุปผลงาน พร้อมแนบไฟล์หลักฐานสูงสุด 5 ไฟล์ต่อวัน                            |
| **สรุปการลา / แผนงานรายเดือน**    | ดูสรุปจำนวนวันแต่ละประเภทในแต่ละเดือน (ลา / WFH / สำนักงาน / ราชการ / พื้นที่)        |

### 🛠️ สำหรับผู้ดูแลระบบ (Admin)

| ฟีเจอร์                        | รายละเอียด                                                                            |
| ------------------------------ | ------------------------------------------------------------------------------------- |
| **Admin Dashboard**            | ภาพรวมองค์กรรายวัน — สถิติตามประเภท, รายชื่อผู้ที่ยังไม่ลงชื่อ, กราฟรายสัปดาห์      |
| **สรุปแผนงานวันพรุ่งนี้**      | Dashboard แสดงแผนงานของพนักงานทุกคนสำหรับวันถัดไปแบบ real-time                        |
| **ปฏิทินแผนงาน (Admin)**       | ดูแผนการปฏิบัติงานของพนักงานทั้งองค์กรในมุมมองรายเดือน (calendar / ตาราง)            |
| **ปฏิทินผลการปฏิบัติงาน**     | ดูผลลัพธ์จริงเทียบกับแผนงานรายเดือน พร้อม Export Excel                               |
| **รายงาน**                     | ค้นหาและกรองข้อมูลตาม ชื่อ / รหัส / วันที่ / ประเภท / หน่วยงาน แบบ Pagination       |
| **Export Excel**               | ดาวน์โหลดรายงานเป็นไฟล์ `.xlsx` รองรับ filter ทุกรูปแบบ                              |
| **Export PDF**                 | พิมพ์รายงานเป็น PDF รองรับภาษาไทย (ฟอนต์ Sarabun)                                    |
| **จัดการผู้ใช้**               | เพิ่ม / แก้ไข / ลบ (soft delete) / รีเซ็ตรหัสผ่านผู้ใช้งาน                           |
| **ดูประวัติรายบุคคล**          | คลิกชื่อพนักงานเพื่อดูประวัติการลงชื่อ 30 รายการล่าสุด                               |
| **จัดการแผนก**                 | เพิ่ม / แก้ไข / ลบหน่วยงาน / แผนก รองรับโครงสร้างลำดับชั้น                           |

### 🗂️ ประเภทการปฏิบัติงาน

| ประเภท    | ไอคอน | คำอธิบาย                              |
| --------- | ----- | ------------------------------------- |
| `WFH`     | 🏠    | ปฏิบัติงาน ณ ที่พัก (Work From Home)  |
| `OFFICE`  | 🏢    | เข้าปฏิบัติงาน ณ สำนักงาน             |
| `FIELD`   | 🚗    | ออกปฏิบัติราชการ / ไปราชการ           |
| `ON_SITE` | 📍    | ออกปฏิบัติงานพื้นที่ (On-site)        |
| `LEAVE`   | 🔴    | ลา (ใช้ในแผนงานเท่านั้น)              |
...
- ✅ ลงชื่อเข้า / ออกงาน พร้อมเลือกประเภท (WFH / OFFICE / FIELD / ON_SITE)
- ✅ ดูสถานะการปฏิบัติงานวันนี้ของตนเอง
- ✅ ดูประวัติการลงชื่อของตนเอง พร้อมกรองและดูรูปหลักฐาน
- ✅ อัปโหลดรูปภาพหลักฐานสูงสุด 3 รูปต่อวัน
- ✅ วางแผนงานรายสัปดาห์ล่วงหน้า (WFH / OFFICE / FIELD / ON_SITE / LEAVE)
- ✅ บันทึกผลการปฏิบัติงานพร้อมแนบไฟล์
- ✅ ดูสรุปแผนงาน / การลารายเดือน
...
- ✅ ทุกอย่างของ STAFF
- ✅ Admin Dashboard — ภาพรวมองค์กรรายวัน พร้อมกราฟและสรุปแผนงานวันพรุ่งนี้
- ✅ ปฏิทินแผนงานและปฏิทินผลลัพธ์ระดับองค์กรรายเดือน (ทุกคน)
- ✅ รายงานและ Export ข้อมูล (Excel / PDF)
- ✅ จัดการผู้ใช้งานทั้งหมด (CRUD + Reset Password)
- ✅ ดูประวัติการลงชื่อของพนักงานทุกคน
- ✅ จัดการหน่วยงาน / แผนก (รองรับโครงสร้างลำดับชั้น)
...
work_plans                   work_plan_attachments
────────────────────────     ──────────────────────────────────
id (PK)                      id (PK)
user_id (FK → users)         work_plan_id (FK → work_plans)
plan_date (DATE)  ┐          file_path / file_name
plan_type         │ UNIQUE   file_size / mime_type
note              ┘ (user_id + plan_date)
actual_note
created_at / updated_at
```

> **Constraint สำคัญ:** พนักงาน 1 คน ลงชื่อได้ **1 ครั้งต่อวัน** และวางแผนได้ **1 แผนต่อวัน** เท่านั้น
...
| Method | Endpoint                              | สิทธิ์     | คำอธิบาย                               |
| ------ | ------------------------------------- | ---------- | -------------------------------------- |
| GET    | `/work-plans/week`                    | Auth       | ดูแผนงานรายสัปดาห์ของตนเอง             |
| POST   | `/work-plans/upsert`                  | Auth       | บันทึก / อัปเดตแผนงาน (upsert by date) |
| DELETE | `/work-plans/:date`                   | Auth       | ลบแผนงานวันที่ระบุ                     |
| PUT    | `/work-plans/:date/actual`            | Auth       | บันทึกผลการปฏิบัติงาน + แนบไฟล์        |
| GET    | `/work-plans/leave-summary`           | Auth       | สรุปการลา / แผนงานรายเดือน             |
| GET    | `/work-plans/admin/month-plans`       | Admin only | ดูแผนงานทั้งองค์กรรายเดือน             |
| GET    | `/work-plans/admin/month-results`     | Admin only | ดูผลการปฏิบัติงานทั้งองค์กรรายเดือน   |
...
โปรเจกต์นี้พัฒนาและดูแลโดยใช้เวลาว่างส่วนตัว หากระบบนี้มีประโยชน์กับคุณหรือองค์กรของคุณ  
สามารถสนับสนุนค่ากาแฟเพื่อเป็นกำลังใจในการพัฒนาต่อเนื่องได้ครับ 🙏

ไม่มากไม่น้อย ตามสะดวกใจเลยครับ — ขอบคุณมากครับ! 😊

<p align="center">
  <img src="donat.jpg" alt="QR Code สนับสนุนโปรเจกต์" width="220" />
</p>

> 📲 สแกน QR Code เพื่อโอนเงินสนับสนุนผ่าน PromptPay / พร้อมเพย์
